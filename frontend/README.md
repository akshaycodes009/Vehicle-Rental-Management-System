# Akshay Kumar Vehicle Rental Dashboard

This repository contains the frontend UI for the Vehicle Rental Management System, adapted and maintained by Akshay Kumar.
Note: The UI is adapted from Material Dashboard 2 React by Creative Tim; the original license and copyright are preserved in `LICENSE.md`.
...
- `public/` — static files, app entry `index.html`
- `src/` — React source code and routes
- `src/components/` — UI components
- `src/layouts/` — page layouts (dashboard, cars, profile, etc.)

If you want me to update UI text (labels, headings) to include your preferred branding, tell me the exact app name you'd like to show (for example: "Akshay Kumar Rentigo").
## License

This project includes UI assets originally from Creative Tim. The original license is included as `LICENSE.md` in this folder.
